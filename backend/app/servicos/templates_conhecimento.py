...
""",
        "conteudo_real": """# Sobre a Empresa

Use este espaço para descrever a sua empresa (Nome oficial, setor de atuação, história, proposta de valor e sede). 

*(Você pode clicar no botão "Usar exemplo" no topo do editor para copiar o modelo oficial e editá-lo)*
"""
    },
    "missao.md": {
        "tipo": "institucional",
...
""",
        "conteudo_real": """# Missão da Empresa

Defina qual é o propósito fundamental e a razão de ser da sua empresa.
...
""",
        "conteudo_real": """# Visão da Empresa

Escreva onde sua empresa pretende chegar no longo prazo e quais são os grandes objetivos estratégicos.
...
""",
        "conteudo_real": """# Cultura e Valores

Defina os pilares éticos, morais e culturais que guiam as atitudes da sua empresa.
...
"""
    ...
    "diferenciais.md": {
        "tipo": "institucional",
        "rotulo": "Diferenciais Competitivos",
...
""",
        "conteudo_real": """# Diferenciais Competitivos

Documente quais são as vantagens únicas da sua marca frente aos concorrentes do mercado.
...
- [Benefício 3]
""",
        "conteudo_real": """# Ficha de Produto: [Nome do Produto / Serviço Principal]

Descreva as características técnicas, valores e benefícios do produto ou serviço principal da sua empresa.
...
- [Diferencial 2]
""",
        "conteudo_real": """# Ficha de Produto: [Nome do Produto Premium / Secundário]

Descreva o seu segundo produto ou plano de maior valor (Enterprise/Premium) para apoiar ofertas de Upsell.
...
""",
        "conteudo_real": """# Ficha de Serviço: Consultoria e Projetos Personalizados

Documente aqui o funcionamento de suas consultorias, termos de projetos, etapas de entrega e onboarding de serviços.
...
- [Termo evitado 2]
""",
        "conteudo_real": """# Diretrizes de Tom de Voz

Defina como sua marca fala com os clientes (palavras-chave bem-vindas, tom emocional, expressões que devem ser evitadas).
...
""",
        "conteudo_real": """# Perfil do Cliente Ideal (Persona)

Mapeie e registre quem são os tomadores de decisão e os compradores ideais das suas soluções.
...
"""
    ...
    "posicionamento.md": {
        "tipo": "marketing",
        "rotulo": "Posicionamento de Marca",
...
""",
        "conteudo_real": """# Posicionamento de Marca

Escreva sobre o posicionamento de mercado da sua empresa, Proposta Única de Valor (PUV) e slogan.
...
[Insira como contornar esta objeção]
""",
        "conteudo_real": """# Manual de Objeções e Contornos de Vendas

Mapeie as principais objeções de seus clientes (Preço, Complexidade, Segurança) e ensine a IA a respondê-las.
...
**Resposta:** [Insira a resposta correta aqui]
""",
        "conteudo_real": """# Perguntas Frequentes (FAQ)

Registre as dúvidas mais corriqueiras que seu suporte ou setor comercial recebem diariamente de clientes.
...
"""
    ...
    "icp.md": {
        "tipo": "cliente",
        "rotulo": "Perfil de Cliente Ideal (ICP)",
...
""",
        "conteudo_real": """# Perfil de Cliente Ideal (ICP)

Registre quais são as métricas organizacionais das empresas que melhor se beneficiam do seu produto ou serviço.
...
"""
    ...
    "onboarding.md": {
        "tipo": "rh",
        "rotulo": "Onboarding de Funcionários",
...
""",
        "conteudo_real": """# Manual de Integração e Boas-Vindas

Insira aqui os passos de treinamento, canais de comunicação e ferramentas para novos membros da sua organização.
...
""",
        "conteudo_real": """# Estrutura de Cargos, Funções e Responsabilidades

Documente a estrutura organizacional (Cargos, Atribuições principais, Requisitos e Departamentos) da sua empresa.
